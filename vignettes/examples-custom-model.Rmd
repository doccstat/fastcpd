...
cases, `fastcpd()` also accepts **pre-compiled C++ cost functions**, passed
...
either interchangeably -- `fastcpd()` detects which kind of SEXP it received
...
Because external pointers carry no `formals()`, `fastcpd()` cannot infer
